...
def optimize(strategy_name, view, *, train_days, test_days, n_samples=200, seed=0,
    ...
    space = build_strategy(strategy_name, base_params, "forex.strategies").search_space()
    if tune is not None:
    ...
    for i in range(1, n_samples + 1):
        ...
        wf = walk_forward(lambda c=cand: build_strategy(strategy_name, c, "forex.strategies"),
    ...
    is_metrics = backtest(build_strategy(strategy_name, best["params"], "forex.strategies"), view, cost_bps).metrics
