...
| Momentum basket on IBKR stocks/crypto | **Rejected 2026-08-25.** Crypto: IBKR's 11 coins = buy-and-hold BTC (Sh 0.49). Equities: loses to equal-weight buy-and-hold on a de-biased universe. [`momentum-basket-ibkr-assessment.md`](./momentum-basket-ibkr-assessment.md) |
