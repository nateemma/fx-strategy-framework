...
- [FX legs are cash, not positions](memory/fx-legs-are-cash-not-positions.md) — nav.csv's `open_legs` counts ETFs, not FX legs; the comment in snapshot_nav.py is wrong.
